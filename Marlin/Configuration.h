...
#define HOTEND_OFFSET_X { 0.0, 19.80 } // (mm) relative X-offset for each nozzle
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 161.5648, 161.5648, 1570.2762, 279.52, 281.38 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 1000, 1000, 12, 120, 120 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 42, 0, -2.4 }
